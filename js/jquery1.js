...
define("MOD_ROOT/comment/showImgSwitch", function (require, exports, module) {
    ...
    return t.prototype = {
        ...
        init: function (t) {
            var e = this;
            t.showImgSwitch = t.showImgSwitch || ".comments-showImgSwitch-wrap", t.thumbList = t.thumbList || ".thumb-list", t.thumbPrevBtn = t.thumbPrevBtn || ".J-thumb-prev", t.thumbNextBtn = t.thumbNextBtn || ".J-thumb-next", t.cursorLeft = t.cursorLeft || ".J-cursor-left", t.cursorRight = t.cursorRight || ".J-cursor-right", t.photoImg = t.photoImg || ".J-photo-img", e.$showImgSwitch = $(t.showImgSwitch), e.$thumbList = $(t.thumbList), e.$thumbListUl = e.$thumbList.find("ul"), e.thumbPrevBtn = t.thumbPrevBtn, e.thumbNextBtn = t.thumbNextBtn, e.$photoImg = $(t.photoImg), e.cursorLeft = t.cursorLeft, e.cursorRight = t.cursorRight, e.template.thumbLi = '<li><a href="javascript:;"><img width="76" height="76" src="${imageUrl}"></a></li>', e.onUpdate = t.onUpdate || e.onUpdate, e.onReady = t.onReady || e.onReady, e.currIndex = 0, e.imgNum = t.imgNum, e.url = t.url, e.wideVersion = t.wideVersion, e.imgArr = [], e._getData()
        },
        _getData: function () {
            var t = this;
            /debug=showImgSwitch/.test(location.href) && console.log("\u5f00\u59cb\u83b7\u53d6\u6570\u636e \u9875\u7801\uff1a" + t.dataPage), $.ajax({
                url: t.url,
        ...
        _bindEvents: function () {
            ...
            t.$showImgSwitch.delegate(t.cursorLeft, "click", function () {
                ...
                t.currentPage < t.totalPage && t.currentPage + 1 <= e && (t.currentPage++, t.currIndex = (t.currentPage - 1) * t.imgNum, t._chooseIndex(t.currIndex))
